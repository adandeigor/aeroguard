  ...
  return (
    <section className="w-full bg-gradient-to-br from-purple-50 to-pink-50 py-12 px-4" id="demo">
        <div className="container mx-auto max-w-7xl">
            ...
            {/* Stats Display */}
            <div className="flex flex-wrap justify-center max-w-2xl mt-8 mx-auto gap-6">
                <Card className="bg-white/80 backdrop-blur-sm w-[46%]">
                    <CardHeader>
                ...
                <Card className="col-span-2 bg-white/80 backdrop-blur-sm w-full">
                    <CardHeader>
